...
$query_select_ranking = "SELECT * FROM resultado ORDER BY pontos DESC";
$query_ranking = $mysqli->query($query_select_ranking);
...
<body>
    ...
    <span>Boa, <?php echo $_SESSION['nome']; ?>!</span><br>
    <span>Aqui está o ranking deste semestre!</span>
    </div>
    ...
    <div class="questoes">
        ...
        <table class="table table-bordered" style="color: #fff; text-align: center" >
            ...
            <?php while($ranking = $query_ranking->fetch_array()){ ?> 
                <tr>
                    <td><?php echo $ranking['nome']; ?></td>
                    <td><?php echo $ranking['pontos']; ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
